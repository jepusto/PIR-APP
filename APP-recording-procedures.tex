...
\hat\rho_{MTS} = \frac{- \log(\hat{p}_1 - \hat{p}_0)}{c}.
\end{equation}

Following a derivation in \citet{Brown1975estimation}, the expected information matrix for $(\phi, \rho)$ can be shown to be 
\begin{equation}
\label{eq:MTS_Info}
\info^{MTS}_{\phi\phi} = 
\end{equation}
