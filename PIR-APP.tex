...
Consequently, methodologists have long argued against the use of PIR and WIR systems \citep[cf.]{Altmann1974observational, Mann1991time, Lane2014using}. \todo[color=green!40]{What is "cf." intended to convey here?}
...
More precisely, the probability that a behavior will be occurring $t$ seconds into the future is independent of the state of the behavior for $0 \leq r < s$: \todo[color=green!40]{What r stands for in this inequality (and below as well) is a little bit opaque to me. Might just be something I need explained to me}
\begin{equation}
\label{eq:Markov}
...
For MTS data, the summary proportion is an unbiased estimate of prevalence under a very broad class of data-generating models \citep{Rogosa1991statistical}; however, the summary proportion may be less efficient\todo[color=green!40]{re: Our e-mail discussion earlier, should this be "accurate"?} than the PLE or MLE for prevalence under the Alternating Poisson Process model. 
...
{\centering \includegraphics[width=\maxwidth]{fig/MTS_RMSE-1} 
...
{\centering \includegraphics[width=\maxwidth]{fig/PIR_RMSE-1} 
...
{\centering \includegraphics[width=\maxwidth]{fig/PIR_sample_size-1} 
...
{\centering \includegraphics[width=\maxwidth]{fig/AIR_RMSE-1} 
...
{\centering \includegraphics[width=\maxwidth]{fig/Method_RMSE-1} 
...
{\centering \includegraphics[width=\maxwidth]{fig/AIR_sample_size-1} 
...
{\centering \includegraphics[width=\maxwidth]{fig/summary_prop-1} 
...
{\centering \includegraphics[width=\maxwidth]{fig/johnson_phi_est-1} 
...
{\centering \includegraphics[width=\maxwidth]{fig/johnson_zeta_est-1} 
