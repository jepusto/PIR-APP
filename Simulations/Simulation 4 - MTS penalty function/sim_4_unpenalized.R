...
system.time(results_unp <- mdply(params, .fun = runSim, iterations = 5000, c = 1, .parallel = TRUE))
save(results_unp, file = "Simulations/Simulation 4 - MTS penalty function/sim4MTS_unp.Rdata")
