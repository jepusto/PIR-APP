...
system.time(results2 <- mdply(params, .fun = runSim, iterations = 5000, c = 1, .parallel = TRUE))
save(results2, file = "Simulations/Simulation 4 - MTS penalty function/sim4MTSpenalized2.Rdata")
